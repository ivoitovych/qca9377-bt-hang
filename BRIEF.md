...
running since 08-25. **Unsent. Three independent reviews (09-18, 09-19 ×2): accept both; message-
only changes applied; no code change. Sending is the operator's word.** Written to BlueZ's
