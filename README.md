...
- **Not established:** the mechanism — *how* traffic on that endpoint wedges the
  device. Regression candidate: `BTUSB_USE_ALT1_FOR_WBS` became an unconditional fallback
  in **v5.11 → v5.12**; a ≤ v5.11 kernel has not been run.
...
retained history, 1 = observed, 2 = cannot determine.
